...
const Services = ({ id }: { id: string }) => {
  return (
    <div
      className="bg-[url('../assets/background2.jpg')] h-screen bg-cover bg-center bg-no-repeat"
      id={id}
    >
      <img
        src={services.src}
      ...
      />
      <div className="flex flex-col justify-between h-[35em] md:h-[40em] lg:h-[35em] sm:h-[25em]">
